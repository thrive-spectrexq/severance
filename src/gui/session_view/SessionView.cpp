...
void SessionView::setupUI() {
  ...
  auto* desc = new QLabel("Log macrodata, provide qualitative annotations, and generate required compliance reports.", this);
  ...
  auto* exportLabel = new QLabel("Compliance Exports", this);
